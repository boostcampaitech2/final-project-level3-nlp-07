...
def parse_arguments():
    ...
    parser.add_argument('--freeze_bert', default=False, type=lambda x: (str(x).lower() == 'true'),
    ...
    parser.add_argument('--data_path', default='data/', type=str, help='path to train/dev/test datasets')
