...
def get_parser():
    ...
    group.add_argument("--mdl_file", type=str, required=True)
    group.add_argument("--wav_scp", type=str, required=True)
...
def main(cmd=None):
    ...
    kwargs = vars(args)
    kwargs.update(o)
    kwargs.update({'data_path_and_name_and_type': [(args.wav_scp, 'speech',
                                                    'sound')]})
    del args.mdl_file
    del args.wav_scp
